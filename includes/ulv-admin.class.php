...
class Ulv_Admin
{
    ...
    public function enqueue_scripts() {
        global $ulv;
        if ( $ulv['admin_page_hk'] == get_current_screen()->id ) {
            wp_register_script( 'ulv-admin-js', ULV_URL . 'assets/js/admin-page.js', array( 'jquery-ui-autocomplete' ),  null);
            ...
            wp_enqueue_style( 'ulv-admin-css', ULV_URL . 'assets/css/admin-page.css', array(),  null);
        }
    }
